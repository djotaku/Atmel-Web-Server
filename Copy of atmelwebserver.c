...
flash unsigned char *index = "HTTP/1.0 200 OK\r\nServer: KickAss Server\r\nContent-type: text/html\r\n\r\n<html><head><meta HTTP-EQUIV=\"content-type\" CONTENT=\"text/html; charset=iso-8859-1\"><title>index</title><link rel=\"shortcut icon\" href=\"/favicon.ico\" type=\"image/x-icon\" ></head><body>index<br /><br /><a href=\"about.html\">about</a>oduction</h1><br><h2>Sound Bite</h2><br>Our project is a fully web-standards compliant webdr</center></body></html>\r\n\r\n";

flash unsigned char *about = "HTTP/1.0 200 OK\r\nServer: KickAss Server\r\nContent-type: text/html\r\n\r\n<html><head><meta HTTP-EQUIV=\"content-type\" CONTENT=\"text/html; charset=iso-8859-1\"><title>about</title><link rel=\"shortcut icon\" href=\"/favicon.ico\" type=\"image/x-icon\" ></head><body>about<br /><a href=\"index.html\">index</a></body></html>\r\n\r\n";
...
void main(void)
{
	...
	delay_ms(200); //wait for boot up (0.2 seconds)
